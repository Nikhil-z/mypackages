...
//    	caIPPVProgramInfos.IPPVProgramInfo[0].sCanTape=1;      /* 是否可以录像：1－可以录像；0－不可以录像 */
//    	caIPPVProgramInfos.IPPVProgramInfo[0].sPrice=0xFF;        /* 节目价格 */
//    	caIPPVProgramInfos.IPPVProgramInfo[0].sExpiredDate=3458;  /* 节目过期时间,IPPV用 */
...
//    	caIPPVProgramInfos.IPPVProgramInfo[1].sCanTape=1;      /* 是否可以录像：1－可以录像；0－不可以录像 */
//    	caIPPVProgramInfos.IPPVProgramInfo[1].sPrice=0xFF;        /* 节目价格 */
//    	caIPPVProgramInfos.IPPVProgramInfo[1].sExpiredDate=3458;  /* 节目过期时间,IPPV用 */
