...
public class Helpers {
    ...
    static String getFullPath(String filename, String mimeType, int destination, File base)
        ...
        return chooseUniqueFilename(destination, filename, extension, false);
    }
    ...
    private static String chooseFilename(String url, String hint, String contentDisposition,
        ...
        if (filename == null) {
            ...
            if (decodedUrl != null
                ...
                if (index > 0) {
                    ...
                    Log.v(Constants.TAG, "uri "+decodedUrl+" filename "+filename);
                }
            }
        }
        ...
        Log.v(Constants.TAG, " filename "+filename);
        return filename;
    }
    ...
    */
    ...
    static boolean isFilenameValid(String filename, File downloadsDataDir) {
        ...
        return filename.startsWith(downloadsDataDir.toString());
    }
